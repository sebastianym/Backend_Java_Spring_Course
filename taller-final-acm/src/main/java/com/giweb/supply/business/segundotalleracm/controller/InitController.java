...
public class InitController {
    ...
    @GetMapping("/init")
    public ResponseEntity<SeedResponseDTO> init() {
    ...
    private void clearExistingData() {
        ...
        administradorGeneralRepository.deleteAll();
    }
    ...
    private List<Integer> createTiposHabitacion(List<Integer> hotelIds) {
        ...
        // Tipos de habitación para el primer hotel
        ...
        // Tipos de habitación para el segundo hotel
    ...
    private List<Integer> createHabitaciones(List<Integer> tipoHabitacionIds, List<Integer> hotelIds) {
        ...
        // Habitaciones para el primer hotel, tipo estándar
        ...
        // Habitaciones para el primer hotel, tipo suite
        ...
        // Habitaciones para el segundo hotel, tipo estándar
        Habitacion hab3 = new Habitacion();
        hab3.setNumeroHabitacion(101);
        ...
        // Habitaciones para el segundo hotel, tipo suite ejecutiva
        Habitacion hab4 = new Habitacion();
        hab4.setNumeroHabitacion(301);
